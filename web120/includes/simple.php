...
$toName = "Kelsie Brown"; //place your client's name here
$website = "Kelsie Brown's Web120 Portal";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        <h3>Your Comments Have Been Received</h3>
